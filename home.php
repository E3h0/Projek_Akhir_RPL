        ...
        <div class="banner">
            <div class="banner-leftbox">
                <div class="banner-leftbox-title">
                    <h1>Hello</h1>
                    <p id="user" style="font-size: 1.4rem;">
						<?php 
						session_start();
            ...
            <div class="banner-rightbox">
                ...
                <div class="banner-rightbox-desc">
                    <div class="banner-rightbox-desc-icont">
                        <svg xmlns="http://www.w3.org/2000/svg" width="84" height="84" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline>
                        </svg>
                    </div>
                    <div class="banner-rightbox-desc-txt">
                        <p>
                            Tes ini dilakukan dalam bentuk kuesioner yang berisi serangkaian pernyataan tentang perasaan kesepian.
                        </p>
                    </div>
                </div>
                <div class="banner-rightbox-button">
                    <a href="pre_test.php?id=<?php echo $id;?>">Get Started</a>
                </div>
            </div>
        </div>
        <div class="footer">
